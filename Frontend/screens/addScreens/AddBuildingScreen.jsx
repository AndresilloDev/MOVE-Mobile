...
const AddBuildingScreen = () => {
    ...
    const handleAddBuilding = async () => {
        ...
        try {
            const building = { name: buildingName };
    ...
    return (
        <View className="flex-1 bg-gray-100">
            ...
            <View className="m-4 ml-6 flex-row items-center">
                ...
                <Text className="text-xl">Agregar Edificio</Text>
            </View>

            {/* Contenido central */}
            <View className="flex-1 items-center justify-center px-4 gap-20 max-2xl:">
                <Text className="text-2xl font-bold mb-4 text-center">Agregar Edificio</Text>
